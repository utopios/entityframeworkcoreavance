...
public partial class QueryBookingDbContext : DbContext
{
    public QueryBookingDbContext()
    {
    }

    public QueryBookingDbContext(DbContextOptions<ReservationSystemContext> options)
        : base(options)
    {
    }
